...
class ProductBrand(models.Model):
    ...
    maker = fields.Char('Fabricante', required=False)
    origin_country = fields.Char('Pais de Origen', required=False)
    proc_country = fields.Char('Pais de Procedencia', required=False)
